...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/summer-queen-cb72
```

A live public deployment of this template is available at [https://summer-queen-cb72.templates.workers.dev](https://summer-queen-cb72.templates.workers.dev)
